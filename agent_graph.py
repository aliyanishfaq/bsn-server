...
from tools_graph import create_beam, create_column, create_wall, create_session, create_roof, create_building_story, create_floor, search_canvas, delete_objects, create_grid, refresh_canvas, create_isolated_footing, create_strip_footing, create_void_in_wall, step_by_step_planner, translate_object, rotate_object
...
tools = [create_beam, create_column, create_wall, create_session, create_roof, create_building_story, create_floor,
         delete_objects, create_grid, search_canvas, refresh_canvas, create_isolated_footing, create_strip_footing, create_void_in_wall, step_by_step_planner, translate_object, rotate_object]
